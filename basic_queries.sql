...
create table employee_details(
    ...
    employee_adsress VARCHAR(50)
)
PRIMARY KEY(employee_id);

insert into course_list(course_title,course_author,course_course_date) value ("mysql","venkat",NOW()),
("angular","roop",NOW()),("api","ravi",NOW());
...
alter table course_list
   modify course_course_two VARCHAR(50) NOT NULL,
   modify course_title VARCHAR(100) INT NOT NULL;
...
select job_titles from employees order by job_titles
